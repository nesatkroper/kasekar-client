    ...
    <div className="flex flex-col min-h-screen">
            ...
            >
              <div className="space-y-2">
                <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">
                  Grow Better with <span className="text-green-600 dark:text-green-400">NatureBoost</span> Fertilizers
                </h1>
                <p className="max-w-[600px] text-muted-foreground md:text-xl">
                  Premium organic and synthetic fertilizers for farmers, gardeners, and agricultural professionals.
                </p>
              </div>
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Our fertilizers are formulated with the perfect balance of nutrients to promote healthy plant growth
          ...
          <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-12">
            ...
            >
              ...
              <p className="text-muted-foreground">
                Environmentally responsible formulations that minimize ecological impact.
              </p>
            </motion.div>
            <motion.div
              className="grid gap-1 text-center"
            ...
            >
              ...
              <p className="text-muted-foreground">Optimized nutrient release for maximum plant uptake and growth.</p>
            </motion.div>
            <motion.div
              className="grid gap-1 text-center"
              whileHover={{ y: -5 }}
            ...
            >
              ...
              <p className="text-muted-foreground">Easy application and quick absorption for immediate results.</p>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32">
        <div className="container px-4 md:px-6">
          ...
          >
            <div className="space-y-2">
              <h2 className="text-3xl font-bold tracking-tighter md:text-4xl">Trusted by Farmers Nationwide</h2>
              <p className="text-muted-foreground md:text-xl">Hear what our customers have to say about our products</p>
            </div>
            <div className="mt-8 space-y-6">
              <div className="rounded-lg bg-background p-6 shadow-md dark:bg-muted">
                <p className="mb-4 italic">
                  "Since switching to NatureBoost fertilizers, my crop yield has increased by 30%. The quality of my
                  produce has also improved significantly."
                </p>
                <div>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-green-600 dark:bg-green-800">
        <div className="container px-4 md:px-6 text-white">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              <h2 className="text-3xl font-bold tracking-tighter md:text-4xl">Ready to Boost Your Growth?</h2>
              <p className="max-w-[900px] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed text-green-100">
                Contact us today to learn more about our products and how they can benefit your crops.
              </p>
            </div>
            <div className="flex flex-col gap-2 min-[400px]:flex-row">
              <Link href="/contact">
                <Button className="bg-white text-green-600 hover:bg-green-50">Contact Us</Button>
              </Link>
              <Link href="/products">

...
export default function BlockedPage() {
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-indigo-950 dark:to-purple-950 relative overflow-hidden"
    ...
    >
      ...
      <div className="absolute inset-0">
        {[...Array(20)].map((_, i) => (
          <motion.div
            key={i}
            className="absolute rounded-full bg-gradient-to-r from-blue-200/30 to-purple-200/30 dark:from-blue-500/10 dark:to-purple-500/10"
            style={{
      ...
      >
        ...
        >
          {/* Soft glow effect */}
          <motion.div
            className="absolute inset-0 bg-gradient-to-r from-blue-400/20 via-purple-400/20 to-cyan-400/20 dark:from-blue-600/20 dark:via-purple-600/20 dark:to-cyan-600/20 rounded-3xl blur-3xl"
            animate={{
              scale: [1, 1.1, 1],
              opacity: [0.3, 0.5, 0.3],
            }}
          ...
          {/* Main card */}
          <motion.div
            className="relative bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-3xl border border-white/50 dark:border-gray-700/50 p-12 text-center shadow-2xl"
          ...
          >
            ...
            >
              <motion.div
                className="flex items-center space-x-3 bg-blue-50 dark:bg-blue-900/30 px-6 py-3 rounded-full border border-blue-200 dark:border-blue-800"
                animate={{
                  boxShadow: [
              ...
              >
                ...
                />
                <span className="text-blue-600 dark:text-blue-300 text-sm font-medium">Temporarily Unavailable</span>
              </motion.div>
            </motion.div>
            ...
            >
              ...
              >
                <div className="w-full h-full bg-gradient-to-br from-blue-400 to-purple-500 dark:from-blue-600 dark:to-purple-700 rounded-full flex items-center justify-center shadow-lg">
                  <motion.svg
            ...
            >
              <motion.h1
                className="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-600 to-cyan-600 dark:from-blue-400 dark:via-purple-400 dark:to-cyan-400 mb-4"
                animate={{
              ...
              <motion.div
                className="h-1 bg-gradient-to-r from-transparent via-blue-400 dark:via-blue-500 to-transparent mx-auto rounded-full"
                initial={{ width: 0 }}
                animate={{ width: "60%" }}
            ...
            <motion.div
              ...
              className="mb-8 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/30 dark:to-purple-900/30 rounded-xl p-6 border border-blue-100 dark:border-blue-800/50"
            >
              <div className="text-2xl font-light text-gray-600 dark:text-gray-300 mb-2">Current Time</div>
              <div className="text-4xl font-bold text-blue-600 dark:text-blue-400">{formatTime(currentTime)}</div>
            </motion.div>
            ...
            >
              ...
              <motion.p
                className="text-2xl text-gray-700 dark:text-gray-200 leading-relaxed font-medium"
                lang="km"
                initial={{ opacity: 0, x: 20 }}
                animate={{ opacity: 1, x: 0 }}
            ...
            <motion.div
              ...
              className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 rounded-xl p-6 border border-green-200 dark:border-green-800/50"
            >
              <motion.div
              ...
              >
                <motion.div
                  className="w-3 h-3 bg-green-400 dark:bg-green-500 rounded-full"
                  animate={{
                    opacity: [1, 0.5, 1],
                  }}
                  transition={{ duration: 2, repeat: Number.POSITIVE_INFINITY }}
            ...
            >
              <div className="w-8 h-8 border-2 border-blue-200 dark:border-blue-700 rounded-full opacity-50" />
            </motion.div>
            ...
            <motion.div
              ...
              transition={{ duration: 3, repeat: Number.POSITIVE_INFINITY }}
            >
              <div className="w-6 h-6 bg-purple-200 dark:bg-purple-700 rounded-full opacity-50" />
            </motion.div>
          </motion.div>
        </motion.div>
      </motion.div>
      ...
      {[...Array(4)].map((_, i) => (
        ...
        >
          <motion.div
            className="w-full h-full border-2 border-blue-200 dark:border-blue-700 rounded-full opacity-30"
            animate={{
              rotate: [0, 360],
            }}
      ...
      <motion.div
        ...
        className="absolute bottom-0 left-0 right-0 bg-white/70 dark:bg-gray-900/70 backdrop-blur-sm border-t border-blue-100 dark:border-blue-900 p-4"
      >
